...
const Login = () => {
    ...
    bg-linear-to-br from-blue-200 to-purple-400' >
        ...
        text-indigo-300 text-sm">
            <h2 className='text-3xl font-sm text-white text-center mb-3' >{state === 'Sign up' ? 'Create your account' : 'Login your account!'}</h2>
            ...
            <form onSubmit={onSubmitHandler} action="">
                ...
                bg-linear-to-r from-indigo-500 to-indigo-900 text-white font-medium" >{state}</button>
            </form>
            {state === 'Sign up' ? (
